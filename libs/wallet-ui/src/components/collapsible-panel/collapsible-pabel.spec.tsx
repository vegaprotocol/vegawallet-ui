...
describe('Collapsible panel', () => {
  it('renders title, arrow and does not render content', () => {
    ...
    expect(screen.getByTestId('collapsible-panel-title')).toHaveTextContent(
      'Title'
    )
    expect(screen.getByTestId('collapsible-panel-content')).toHaveClass(
      'hidden'
    )
  ...
  it('opens panel on click', () => {
    ...
    expect(screen.getByTestId('collapsible-panel-content')).not.toHaveClass(
      'hidden'
    )
