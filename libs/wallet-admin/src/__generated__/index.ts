...
export type WalletAPIRequest = 
  & ((id: Identifier.CreateWallet, params: WalletModel.CreateWalletParams) => Promise<WalletModel.CreateWalletResult>)
  & ((id: Identifier.ImportWallet, params: WalletModel.ImportWalletParams) => Promise<WalletModel.ImportWalletResult>)
  & ((id: Identifier.DescribeWallet, params: WalletModel.DescribeWalletParams) => Promise<WalletModel.DescribeWalletResult>)
  & ((id: Identifier.ListWallets, params: WalletModel.ListWalletsParams) => Promise<WalletModel.ListWalletsResult>)
  & ((id: Identifier.RenameWallet, params: WalletModel.RenameWalletParams) => Promise<WalletModel.RenameWalletResult>)
  & ((id: Identifier.RemoveWallet, params: WalletModel.RemoveWalletParams) => Promise<WalletModel.RemoveWalletResult>)
  & ((id: Identifier.ListNetworks, params: WalletModel.ListNetworksParams) => Promise<WalletModel.ListNetworksResult>)
  & ((id: Identifier.DescribeNetwork, params: WalletModel.DescribeNetworkParams) => Promise<WalletModel.DescribeNetworkResult>)
  & ((id: Identifier.UpdateNetwork, params: WalletModel.UpdateNetworkParams) => Promise<WalletModel.UpdateNetworkResult>)
  & ((id: Identifier.RemoveNetwork, params: WalletModel.RemoveNetworkParams) => Promise<WalletModel.RemoveNetworkResult>)
  & ((id: Identifier.ImportNetwork, params: WalletModel.ImportNetworkParams) => Promise<WalletModel.ImportNetworkResult>)
  & ((id: Identifier.GenerateKey, params: WalletModel.GenerateKeyParams) => Promise<WalletModel.GenerateKeyResult>)
  & ((id: Identifier.DescribeKey, params: WalletModel.DescribeKeyParams) => Promise<WalletModel.DescribeKeyResult>)
  & ((id: Identifier.ListKeys, params: WalletModel.ListKeysParams) => Promise<WalletModel.ListKeysResult>)
  & ((id: Identifier.AnnotateKey, params: WalletModel.AnnotateKeyParams) => Promise<WalletModel.AnnotateKeyResult>)
  & ((id: Identifier.IsolateKey, params: WalletModel.IsolateKeyParams) => Promise<WalletModel.IsolateKeyResult>)
  & ((id: Identifier.RotateKey, params: WalletModel.RotateKeyParams) => Promise<WalletModel.RotateKeyResult>)
  & ((id: Identifier.TaintKey, params: WalletModel.TaintKeyParams) => Promise<WalletModel.TaintKeyResult>)
  & ((id: Identifier.UntaintKey, params: WalletModel.UntaintKeyParams) => Promise<WalletModel.UntaintKeyResult>)
  & ((id: Identifier.DescribePermissions, params: WalletModel.DescribePermissionsParams) => Promise<WalletModel.DescribePermissionsResult>)
  & ((id: Identifier.ListPermissions, params: WalletModel.ListPermissionsParams) => Promise<WalletModel.ListPermissionsResult>)
  & ((id: Identifier.UpdatePermissions, params: WalletModel.UpdatePermissionsParams) => Promise<WalletModel.UpdatePermissionsResult>)
  & ((id: Identifier.RevokePermissions, params: WalletModel.RevokePermissionsParams) => Promise<WalletModel.RevokePermissionsResult>)
  & ((id: Identifier.PurgePermissions, params: WalletModel.PurgePermissionsParams) => Promise<WalletModel.PurgePermissionsResult>)
  & ((id: Identifier.SignTransaction, params: WalletModel.SignTransactionParams) => Promise<WalletModel.SignTransactionResult>)
  & ((id: Identifier.SignMessage, params: WalletModel.SignMessageParams) => Promise<WalletModel.SignMessageResult>)
  & ((id: Identifier.VerifyMessage, params: WalletModel.VerifyMessageParams) => Promise<WalletModel.VerifyMessageResult>)
  & ((id: Identifier.SendTransaction, params: WalletModel.SendTransactionParams) => Promise<WalletModel.SendTransactionResult>)
  & ((id: Identifier.SendRawTransaction, params: WalletModel.SendRawTransactionParams) => Promise<WalletModel.SendRawTransactionResult>)
  & ((id: Identifier.StartService, params: WalletModel.StartServiceParams) => Promise<WalletModel.StartServiceResult>)
  & ((id: Identifier.StopService, params: WalletModel.StopServiceParams) => Promise<WalletModel.StopServiceResult>)
  & ((id: Identifier.ListConnections, params: WalletModel.ListConnectionsParams) => Promise<WalletModel.ListConnectionsResult>)
  & ((id: Identifier.CloseConnection, params: WalletModel.CloseConnectionParams) => Promise<WalletModel.CloseConnectionResult>)
  & ((id: Identifier.CloseConnectionsToHostname, params: WalletModel.CloseConnectionsToHostnameParams) => Promise<WalletModel.CloseConnectionsToHostnameResult>)
  & ((id: Identifier.CloseConnectionsToWallet, params: WalletModel.CloseConnectionsToWalletParams) => Promise<WalletModel.CloseConnectionsToWalletResult>)
...
export class WalletAdmin {
  ...
  // tslint:disable-next-line:max-line-length
  public SendRawTransaction = (params: WalletModel.SendRawTransactionParams) => {
  ...
  // tslint:disable-next-line:max-line-length
  public CloseConnectionsToHostname = (params: WalletModel.CloseConnectionsToHostnameParams) => {
  ...
  // tslint:disable-next-line:max-line-length
  public CloseConnectionsToWallet = (params: WalletModel.CloseConnectionsToWalletParams) => {
