...
export function MockAPIRequest(id: Identifier) {
  switch (id) {
    ...
    case Identifier.SignTransaction: {
      return Promise.resolve<WalletModel.SignTransactionResult>(undefined)
    }
    ...
    case Identifier.VerifyMessage: {
      return Promise.resolve<WalletModel.VerifyMessageResult>(undefined)
    }
    case Identifier.SendTransaction: {
      return Promise.resolve<WalletModel.SendTransactionResult>(undefined)
    }
    case Identifier.SendRawTransaction: {
      return Promise.resolve<WalletModel.SendRawTransactionResult>(undefined)
    }
