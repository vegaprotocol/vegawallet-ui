...
export const openrpcDocument: OpenRPC = {
  openrpc: '1.2.6',
  ...
  methods: [
    {
      ...
      tags: [{ name: 'client' }, { name: 'connection' }, { name: 'wallet' }],
    ...
    },
    {
      ...
      result: { name: 'No result', schema: false },
      examples: [
        {
    ...
    },
    {
      ...
      tags: [{ name: 'client' }, { name: 'permissions' }],
      paramStructure: 'by-name',
      params: [
        {
          name: 'token',
      ...
      result: {
        ...
        schema: {
          ...
          properties: {
            permissions: { $ref: '#/components/schemas/permissions_summary' },
          },
        },
      },
      examples: [
        {
          ...
          result: { name: 'Success', value: { publicKeys: 'read' } },
        },
      ],
    },
    {
      ...
      params: [
        ...
        },
        {
          ...
          required: true,
          schema: { $ref: '#/components/schemas/permissions_summary' },
        },
      ],
      result: {
        name: 'Success',
      ...
      examples: [
        {
          ...
          params: [
            ...
            { name: 'requestedPermissions', value: { publicKeys: 'read' } },
          ],
          result: {
            name: 'Success',
            value: { permissions: { publicKeys: 'read' } },
          },
        },
        {
          ...
          result: {
            name: 'Success',
            value: { permissions: { publicKeys: 'none' } },
          },
        },
      ],
    },
      ...
      result: {
        ...
        schema: {
          ...
          properties: {
            keys: {
              type: 'array',
              items: { $ref: '#/components/schemas/named_public_key' },
            },
          },
        },
      },
      errors: [{ $ref: '#/components/errors/read_access_public_keys' }],
      examples: [
        {
    ...
    },
    {
      ...
      tags: [{ name: 'client' }, { name: 'transaction' }],
      paramStructure: 'by-name',
      params: [
        {
          name: 'token',
        ...
        },
        {
          ...
          required: true,
          schema: { $ref: '#/components/schemas/encoded_transaction' },
        },
      ],
      result: {
        name: 'Success',
        ...
        schema: {
          ...
          properties: {
            transaction: { $ref: '#/components/schemas/signed_transaction' },
          },
        },
      },
      errors: [
    ...
    },
    {
      ...
      params: [
        ...
        },
        {
          name: 'sendingMode',
          required: true,
          schema: { $ref: '#/components/schemas/sending_mode' },
        },
        {
          name: 'encodedTransaction',
          required: true,
      ...
      result: {
        ...
        schema: {
          type: 'object',
          required: ['receivedAt', 'sentAt', 'transactionHash', 'transaction'],
          properties: {
            receivedAt: {
              type: 'string',
              description:
    ...
    },
    {
      ...
      tags: [{ name: 'admin' }, { name: 'wallet' }],
      paramStructure: 'by-name',
      params: [
        { name: 'wallet', required: true, schema: { type: 'string' } },
        { name: 'passphrase', required: true, schema: { type: 'string' } },
      ],
      result: {
        name: 'Success',
        required: true,
        schema: {
          ...
          properties: {
            wallet: {
              ...
              required: ['name', 'version', 'recoveryPhrase', 'filePath'],
              properties: {
                name: { type: 'string' },
                version: { type: 'number' },
            ...
            key: {
              ...
              required: ['publicKey', 'algorithm', 'metadata'],
              properties: {
                publicKey: { $ref: '#/components/schemas/public_key' },
      ...
      examples: [
        {
          ...
          params: [
            { name: 'wallet', value: 'my-wallet' },
            { name: 'passphrase', value: 'this-is-not-a-good-passphrase' },
          ],
          result: {
            name: 'Success',
            value: {
              ...
              key: {
                publicKey:
                  'b5fd9d3c4ad553cb3196303b6e6df7f484cf7f5331a572a45031239fd71ad8a0',
                algorithm: { name: 'vega/ed25519', version: 1 },
                metadata: [{ key: 'name', value: 'my-wallet key 1' }],
              },
            },
          },
        },
    ...
    },
    {
      ...
      params: [
        { name: 'wallet', required: true, schema: { type: 'string' } },
        { name: 'passphrase', required: true, schema: { type: 'string' } },
        { name: 'recoveryPhrase', required: true, schema: { type: 'string' } },
        { name: 'version', required: true, schema: { type: 'number' } },
      ],
      result: {
        name: 'Success',
        required: true,
        schema: {
          ...
          properties: {
            wallet: {
              ...
              required: ['name', 'version', 'filePath'],
              properties: {
                name: { type: 'string' },
                version: { type: 'number' },
                filePath: { type: 'string' },
    ...
    },
    {
      ...
      result: {
        ...
        schema: {
          type: 'object',
          required: ['wallets'],
          properties: { wallets: { type: 'array', items: { type: 'string' } } },
        },
      },
      examples: [
        {
          ...
          result: {
            name: 'Success',
            value: { wallets: ['wallet-1', 'wallet-2'] },
          },
        },
      ],
    },
    {
      ...
      params: [
        { name: 'wallet', required: true, schema: { type: 'string' } },
        { name: 'newName', required: true, schema: { type: 'string' } },
        { name: 'passphrase', required: true, schema: { type: 'string' } },
      ],
      result: { name: 'Success', required: true, schema: { type: 'null' } },
      examples: [
        {
          name: 'Rename a wallet',
          params: [
            { name: 'wallet', value: 'my-wallet' },
            { name: 'newWallet', value: 'my-new-wallet-name' },
            { name: 'passphrase', value: 'this-is-not-a-good-passphrase' },
          ],
    ...
    },
    {
      ...
      tags: [{ name: 'admin' }, { name: 'wallet' }],
      paramStructure: 'by-name',
      params: [{ name: 'wallet', required: true, schema: { type: 'string' } }],
      result: { name: 'Success', required: true, schema: { type: 'null' } },
      examples: [
        {
          name: 'Remove a wallet',
          params: [{ name: 'wallet', value: 'my-wallet' }],
          result: { name: 'Success', value: {} },
        },
      ],
    },
      ...
      examples: [
        {
          ...
          result: {
            name: 'Success',
            value: { networks: ['mainnet', 'fairground', 'local-network'] },
          },
        },
      ],
    },
    {
      ...
      tags: [{ name: 'admin' }, { name: 'network' }],
      paramStructure: 'by-name',
      params: [{ name: 'network', required: true, schema: { type: 'string' } }],
      result: {
        name: 'Success',
        required: true,
        schema: {
          type: 'object',
          required: ['name', 'logLevel', 'tokenExpiry', 'port', 'host', 'api'],
          properties: {
            name: { type: 'string' },
            ...
            port: { type: 'integer' },
            host: { type: 'string' },
            api: { $ref: '#/components/schemas/network_api_config' },
          },
        },
      },
      examples: [
        {
          ...
          params: [{ name: 'name', value: 'local-network' }],
          result: {
            name: 'Success',
            value: {
              name: 'local-network',
              ...
              host: 'localhost',
              api: {
                grpcConfig: { hosts: ['localhost:3028'], retries: 5 },
                graphQLConfig: { hosts: ['localhost:3028'] },
                restConfig: { hosts: ['localhost:3029'] },
              },
            },
          },
        },
    ...
    },
    {
      ...
      params: [
        ...
        { name: 'logLevel', required: true, schema: { type: 'string' } },
        { name: 'tokenExpiry', required: true, schema: { type: 'string' } },
        { name: 'port', required: true, schema: { type: 'integer' } },
        { name: 'host', required: true, schema: { type: 'string' } },
        {
          name: 'api',
          required: true,
          schema: { $ref: '#/components/schemas/network_api_config' },
        },
      ],
      result: { name: 'Success', required: true, schema: { type: 'null' } },
      examples: [
        {
          ...
          params: [
            { name: 'name', value: 'local-network' },
            { name: 'level', value: 'info' },
            { name: 'tokenExpiry', value: '168h0m0s' },
            { name: 'port', value: '1789' },
      ...
      examples: [
        {
          ...
          params: [{ name: 'network', value: 'fairground' }],
          result: { name: 'Success', value: {} },
        },
      ],
    },
    {
      ...
      params: [
        ...
        { name: 'filePath', required: true, schema: { type: 'string' } },
        { name: 'url', required: true, schema: { type: 'string' } },
        { name: 'overwrite', required: true, schema: { type: 'boolean' } },
      ],
      result: {
        name: 'Success',
        required: true,
      ...
      examples: [
        {
          ...
          params: [
            { name: 'name', value: 'local-network' },
            { name: 'filePath', value: '/Users/username/local-network.toml' },
          ],
          result: {
            name: 'Success',
            value: {
    ...
    },
    {
      ...
      params: [
        ...
        { name: 'passphrase', required: true, schema: { type: 'string' } },
        {
          ...
          schema: {
            type: 'array',
            items: { schema: { $ref: '#/components/schemas/metadata' } },
          },
        },
      ],
      result: {
      ...
      examples: [
        {
          ...
          params: [
            { name: 'wallet', value: 'my-wallet' },
            { name: 'passphrase', value: 'this-is-not-a-good-passphrase' },
            { name: 'metadata', value: [{ name: 'portfolio', value: 'btc' }] },
          ],
          result: {
            name: 'Success',
            value: {
              ...
              algorithm: { name: 'vega/ed25519', version: 1 },
              metadata: [
                { key: 'portfolio', value: 'btc' },
                { key: 'name', value: 'Key 1' },
              ],
            },
          },
        },
    ...
    },
    {
      ...
      result: {
        ...
        schema: {
          type: 'object',
          required: ['publicKey', 'algorithm', 'metadata', 'isTainted'],
          properties: {
            publicKey: { $ref: '#/components/schemas/public_key' },
            algorithm: { $ref: '#/components/schemas/algorithm' },
            metadata: {
    ...
    },
    {
      ...
      result: {
        ...
        schema: {
          type: 'object',
          required: ['masterPublicKey', 'encodedTransaction'],
          properties: {
            masterPublicKey: {
              description:
      ...
      examples: [
        {
          ...
          params: [
            ...
            { name: 'chainID', value: 'test-chain-Thz9c6' },
            { name: 'submissionBlockHeight', value: 10 },
            { name: 'enactmentBlockHeight', value: 15 },
          ],
          result: {
            name: 'Success',
            value: {
    ...
    },
    {
      ...
      tags: [{ name: 'admin' }, { name: 'permissions' }],
      paramStructure: 'by-name',
      params: [
        { name: 'wallet', required: true, schema: { type: 'string' } },
        { name: 'passphrase', required: true, schema: { type: 'string' } },
        { name: 'hostname', required: true, schema: { type: 'string' } },
      ],
      result: {
        name: 'Success',
        required: true,
      ...
      examples: [
        {
          ...
          result: {
            ...
            value: {
              permissions: {
                'vega.xyz': { public_keys: 'read' },
                'token.vega.xyz': { public_keys: 'none' },
              },
            },
          },
        },
    ...
    },
    {
      ...
      tags: [{ name: 'admin' }, { name: 'transaction' }],
      paramStructure: 'by-name',
      params: [
        { name: 'wallet', required: true, schema: { type: 'string' } },
        { name: 'passphrase', required: true, schema: { type: 'string' } },
        { name: 'pubKey', required: true, schema: { type: 'string' } },
        { name: 'chainId', required: true, schema: { type: 'string' } },
        { name: 'blockHeight', required: true, schema: { type: 'integer' } },
        { name: 'network', schema: { type: 'integer' } },
        { name: 'encodedCommand', required: true, schema: { type: 'string' } },
      ],
      result: {
        name: 'Success',
        required: true,
        schema: {
          ...
          properties: { encodedTransaction: { type: 'string' } },
        },
      },
    },
    {
      ...
      result: {
        ...
        schema: {
          type: 'object',
          required: ['encodedSignature'],
          properties: { encodedSignature: { type: 'string' } },
        },
      },
    },
    {
      ...
      result: {
        ...
        schema: {
          type: 'object',
          required: ['isValid'],
          properties: { isValid: { type: 'string' } },
        },
      },
    },
    {
  ...
  components: {
    schemas: {
      signed_transaction: {
        ...
        required: ['inputData', 'signature', 'from', 'version', 'pow'],
        properties: {
          inputData: { type: 'string' },
          signature: {
            type: 'object',
            required: ['value', 'algo', 'version'],
            properties: {
              value: { type: 'string' },
              algo: { type: 'string' },
              version: { type: 'number' },
          ...
          pow: {
            type: 'object',
            required: ['tid', 'nonce'],
            properties: { tid: { type: 'string' }, nonce: { type: 'number' } },
          },
        },
      },
      token: {
      ...
      permissions_summary: {
        ...
        properties: {
          public_keys: { $ref: '#/components/schemas/access_mode' },
        },
      },
      permissions: {
        type: 'object',
        ...
        properties: {
          publicKeys: {
            ...
            required: ['access', 'restrictedKeys'],
            properties: {
              access: { $ref: '#/components/schemas/access_mode' },
              restrictedKeys: {
                type: 'array',
                description:
      ...
      network_api_config: {
        ...
        required: ['grpcConfig', 'graphQLConfig', 'restConfig'],
        properties: {
          grpcConfig: {
            type: 'object',
            required: ['hosts', 'retries'],
            properties: {
      ...
      last_block_data: {
        ...
        properties: {
          ...
          chainID: { type: 'string' },
          proofOfWorkDifficulty: { type: 'string' },
        },
      },
      sending_mode: {
        type: 'string',
...
export class WalletClient {
  ...
  public ClientConnectWallet = (
    params: WalletModel.ClientConnectWalletParams
  ) => {
    return this.request<WalletModel.ClientConnectWalletResult>(
  ...
  // tslint:disable-next-line:max-line-length
  public ClientDisconnectWallet = (
    params: WalletModel.ClientDisconnectWalletParams
  ) => {
    return this.request<WalletModel.ClientDisconnectWalletResult>(
  ...
  // tslint:disable-next-line:max-line-length
  public ClientGetPermissions = (
    params: WalletModel.ClientGetPermissionsParams
  ) => {
    return this.request<WalletModel.ClientGetPermissionsResult>(
  ...
  // tslint:disable-next-line:max-line-length
  public ClientRequestPermissions = (
    params: WalletModel.ClientRequestPermissionsParams
  ) => {
    return this.request<WalletModel.ClientRequestPermissionsResult>(
  ...
  public ClientListKeys = (params: WalletModel.ClientListKeysParams) => {
    return this.request<WalletModel.ClientListKeysResult>(
      'client.list_keys',
      params
    )
  }
  ...
  // tslint:disable-next-line:max-line-length
  public ClientSignTransaction = (
    params: WalletModel.ClientSignTransactionParams
  ) => {
    return this.request<WalletModel.ClientSignTransactionResult>(
  ...
  // tslint:disable-next-line:max-line-length
  public ClientSendTransaction = (
    params: WalletModel.ClientSendTransactionParams
  ) => {
    return this.request<WalletModel.ClientSendTransactionResult>(
  ...
  public ClientGetChainId = (params: WalletModel.ClientGetChainIdParams) => {
    return this.request<WalletModel.ClientGetChainIdResult>(
      'client.get_chain_id',
      params
    )
  }
  ...
  public CreateWallet = (params: WalletModel.CreateWalletParams) => {
    return this.request<WalletModel.CreateWalletResult>(
      'admin.create_wallet',
      params
    )
  }
  ...
  public ImportWallet = (params: WalletModel.ImportWalletParams) => {
    return this.request<WalletModel.ImportWalletResult>(
      'admin.import_wallet',
      params
    )
  }
  ...
  public DescribeWallet = (params: WalletModel.DescribeWalletParams) => {
    return this.request<WalletModel.DescribeWalletResult>(
  ...
  public ListWallets = (...params: WalletModel.ListWalletsParams) => {
    return this.request<WalletModel.ListWalletsResult>(
      'admin.list_wallets',
      params
    )
  }
  ...
  public RenameWallet = (params: WalletModel.RenameWalletParams) => {
    return this.request<WalletModel.RenameWalletResult>(
      'admin.rename_wallet',
      params
    )
  }
  ...
  public RemoveWallet = (params: WalletModel.RemoveWalletParams) => {
    return this.request<WalletModel.RemoveWalletResult>(
      'admin.remove_wallet',
      params
    )
  }
  ...
  public ListNetworks = (...params: WalletModel.ListNetworksParams) => {
    return this.request<WalletModel.ListNetworksResult>(
      'admin.list_networks',
      params
    )
  }
  ...
  public DescribeNetwork = (params: WalletModel.DescribeNetworkParams) => {
    return this.request<WalletModel.DescribeNetworkResult>(
  ...
  public UpdateNetwork = (params: WalletModel.UpdateNetworkParams) => {
    return this.request<WalletModel.UpdateNetworkResult>(
  ...
  public RemoveNetwork = (params: WalletModel.RemoveNetworkParams) => {
    return this.request<WalletModel.RemoveNetworkResult>(
  ...
  public ImportNetwork = (params: WalletModel.ImportNetworkParams) => {
    return this.request<WalletModel.ImportNetworkResult>(
  ...
  public GenerateKey = (params: WalletModel.GenerateKeyParams) => {
    return this.request<WalletModel.GenerateKeyResult>(
      'admin.generate_key',
      params
    )
  }
  ...
  public DescribeKey = (params: WalletModel.DescribeKeyParams) => {
    return this.request<WalletModel.DescribeKeyResult>(
      'admin.describe_key',
      params
    )
  }
  ...
  public AnnotateKey = (params: WalletModel.AnnotateKeyParams) => {
    return this.request<WalletModel.AnnotateKeyResult>(
      'admin.annotate_key',
      params
    )
  }
  ...
  public IsolateKey = (params: WalletModel.IsolateKeyParams) => {
    return this.request<WalletModel.IsolateKeyResult>(
      'admin.isolate_key',
      params
    )
  }
  ...
  public UntaintKey = (params: WalletModel.UntaintKeyParams) => {
    return this.request<WalletModel.UntaintKeyResult>(
      'admin.untaint_key',
      params
    )
  }
  ...
  public DescribePermissions = (
    ...
    return this.request<WalletModel.DescribePermissionsResult>(
  ...
  public ListPermissions = (params: WalletModel.ListPermissionsParams) => {
    return this.request<WalletModel.ListPermissionsResult>(
  ...
  public UpdatePermissions = (params: WalletModel.UpdatePermissionsParams) => {
    return this.request<WalletModel.UpdatePermissionsResult>(
  ...
  public RevokePermissions = (params: WalletModel.RevokePermissionsParams) => {
    return this.request<WalletModel.RevokePermissionsResult>(
  ...
  public PurgePermissions = (params: WalletModel.PurgePermissionsParams) => {
    return this.request<WalletModel.PurgePermissionsResult>(
  ...
  public SignTransaction = (params: WalletModel.SignTransactionParams) => {
    return this.request<WalletModel.SignTransactionResult>(
  ...
  public SignMessage = (params: WalletModel.SignMessageParams) => {
    return this.request<WalletModel.SignMessageResult>(
      'admin.sign_message',
      params
    )
  }
  ...
  public VerifyMessage = (params: WalletModel.VerifyMessageParams) => {
    return this.request<WalletModel.VerifyMessageResult>(
  ...
  public SendTransaction = (params: WalletModel.SendTransactionParams) => {
    return this.request<WalletModel.SendTransactionResult>(
